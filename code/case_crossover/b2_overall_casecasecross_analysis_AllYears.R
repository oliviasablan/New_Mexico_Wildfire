...
# We will loop through both ED and ESSENCE data so we need to define all the names of the files we need to read
# in as well as the files we will output
infiles = c('casecross_listAllYears_KATE_ED.rds', 'casecross_listAllYears_KATE_ESSENCE.rds')
outfilelaggedR = c('lagged_resultsAllYears_KATE_ED.rds', 'lagged_resultsAllYears_KATE_ESSENCE.rds')
outfilelaggedCSV = c('lagged_resultsAllYears_KATE_ED.csv', 'lagged_resultsAllYears_KATE_ESSENCE.csv')
outfilecummR = c('cumulative_resultsAllYears_KATE_ED.rds', 'cumulative_resultsAllYears_KATE_ESSENCE.rds')

for (q in (1:2)){
  # Read in case-crossover dataset from 'a2_preparehealthforCC_allYears.R"
  ...
  outfile1 <- paste0('C:/Users/olivia.sablan/Desktop/Code from Grace/Data/lagged_results/', outfilelaggedR[q])
  outfile2 <- paste0('C:/Users/olivia.sablan/Desktop/Code from Grace/Data/cumulative_results/', outfilecummR[q])
  outfile3 <- paste0('C:/Users/olivia.sablan/Desktop/Code from Grace/Data/lagged_results/', outfilelaggedCSV[q])
