...
outfilecummCSV = c('cumulative_resultsAllYears_KATE_ED.csv', 'cumulative_resultsAllYears_KATE_ESSENCE.csv')
...
for (q in (1:2)){
  ...
  # use distributed lag function defined above
  lag_est <- data.frame()
  ...
  outfile1 <- paste0('C:/Users/olivia.sablan/Desktop/Code from Grace/Data/cumulative_results/', outfilecummCSV[q])
  outfile2 <- paste0('C:/Users/olivia.sablan/Desktop/Code from Grace/Data/lagged_results/', outfilelaggedCSV[q])
